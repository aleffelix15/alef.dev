export const SITE_DATA = {
  ...
  projects: [
    ...
    },
    {
      id: "geekfilme",
      name: "GEEKFILME",
      subtitle: "Catálogo Streaming Geek",
      category: "Frontend · UI/UX",
      isHighlight: true,
      metric: "100% responsivo em 3 breakpoints",
      demoType: "geekfilme",
      desc: "Uma interface web focada na experiência do usuário para um catálogo de filmes e séries de cultura geek, inspirada em plataformas de streaming como Netflix e Disney+.",
      whyCreated: "Para praticar e aprofundar meus conhecimentos em desenvolvimento responsivo, estruturação de grids, manipulação de componentes de interface visual e consumo de layouts modernos no front-end.",
      whatItIsFor: "Serve como um modelo de apresentação e navegação de mídia (filmes, séries, clássicos, lançamentos), permitindo buscar, listar e visualizar o catálogo em diferentes tamanhos de tela com fluidez.",
      whatIDeveloped: "Construí todo o front-end, aplicando HTML5 para a semântica, CSS3 para a identidade visual (tema dark e cores de destaque) e o framework Bootstrap 4 para garantir o sistema de grid responsivo. Implementei também um carrossel de destaques dinâmico usando jQuery e componentes interativos (Navbar, Dropdowns e modais de login).",
      results: "O projeto demonstra minha capacidade de criar interfaces ricas, fiéis a requisitos de design, focadas na experiência do usuário e prontas para integração com APIs de back-end.",

    ...
    <section id="stack" className="bg-[#050505] py-24">
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-[#F5F5F5] leading-tight">
            ...
            >
              ...
              <div className="flex flex-wrap gap-3">
                {category.techs.map((tech, techIndex) => (
                  <div
                    key={techIndex}
                    className="flex items-center gap-2.5 bg-[#0D0D0F] border border-[#1C1C20] hover:border-[#2E2E38] hover:bg-[#111114] rounded-xl px-4 py-2.5 transition-all duration-300 shadow-sm"
                  >

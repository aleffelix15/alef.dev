...
export const VerticeDemo: React.FC = () => {
  ...
  const products = [
    ...
    { id: 4, name: "Cap — Signal", category: "Acessórios", price: "R$ 129,90", image: "/vertice/cap-signal.jpg" },
  ];
  ...
  return (
    <div className="vertice-demo w-full h-full min-h-[300px] max-h-[420px] bg-[#050505] border border-[#1C1C20] rounded-xl flex flex-col overflow-hidden relative select-none font-sans">
      ...
      {/* Navbar */}
      <div className="vertice-demo__nav flex flex-shrink-0 items-center justify-between border-b border-[#1C1C20] bg-[#0A0A0C] z-10">
        <div className="vertice-demo__nav-left flex items-center">
          <span className="text-[#F5F5F5] font-display font-bold text-sm tracking-widest uppercase">VÉRTICE</span>
          <div className="vertice-demo__categories items-center text-[11px] text-[#A1A1AA] font-medium">
        ...
        <div className="vertice-demo__actions flex items-center">
          <div className="vertice-demo__desktop-search items-center bg-[#151518] border border-[#2A2A30] rounded-md px-3 py-1.5 w-48 transition-colors focus-within:border-[#9b4dff]/50">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-[#2A2A30] [&::-webkit-scrollbar-thumb]:rounded-full">
        ...
        {/* Mobile Search Bar */}
        <div className="vertice-demo__mobile-search">
        ...
        <div className="vertice-demo__content flex flex-col">
          ...
          <motion.div 
            ...
            className="vertice-demo__hero w-full rounded-xl relative overflow-hidden group cursor-pointer border border-[#1C1C20]"
          >
            <img 
            ...
            <div className="vertice-demo__hero-content absolute inset-0 flex flex-col justify-center">
              <span className="vertice-demo__hero-eyebrow uppercase font-medium tracking-wider text-[#A1A1AA] mb-2">
                Coleção Exclusiva
              </span>
              <h2 className="vertice-demo__hero-title font-bold text-[#F5F5F5] leading-tight mb-4 font-display">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="vertice-demo__products grid grid-cols-2 pb-4">

          ...
          <div ref={containerRef} className="relative pl-8 md:pl-10">
            ...
            >
              ...
              <h4 className="font-display text-[1.125rem] text-[#71717A] mb-8 flex items-center gap-2">
                ...
                {t.education.selfTaughtSubtitle}
              </h4>
